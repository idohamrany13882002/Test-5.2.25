...
conn, curser = connect_db("test.db")
try:
    query(curser, conn, "DROP TABLE IF EXISTS movies;")
    query(curser, conn, """
    CREATE TABLE movies (
    ...
    # u_year: str = input("Enter a movie's year: ")
    # u_revenue: str = input("Enter a movie's revenue: ")
    #
    # update_query(curser, conn, """"
    # INSERT INTO movies (movie_name, genre, country, language, year, revenue) VALUES
    # (?,?,?,?,?,?)
